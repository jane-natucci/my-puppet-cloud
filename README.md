...
1. [Setup - The basics of getting started with cloud](#setup)
    * [What cloud affects](#what-cloud-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with cloud](#beginning-with-cloud)
